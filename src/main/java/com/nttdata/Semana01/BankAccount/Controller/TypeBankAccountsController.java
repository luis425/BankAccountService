...
public class TypeBankAccountsController {
	...
	@GetMapping(value = "/typeBankAccountbyId/{id}")
	public Mono<TypeBankAccounts> getCustomerById(@PathVariable Integer id) {
		return this.typeBankAccountsService.getTypeBankAccountsbyId(id); 
	}
